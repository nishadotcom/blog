	...
	<?php echo form_open('', ['class' => 'form-horizontal']); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				<?php echo form_input('title', set_value('title'), ['id'=>'title', 'name'=>'title', 'class'=>'form-control', 'tabindex'=>'2']); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<?php echo form_textarea('content', set_value('content'), ['id'=>'content', 'name'=>'content', 'class'=>'form-control editor', 'tabindex'=>'3']); ?>
