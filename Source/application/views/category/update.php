	...
	<?php echo form_open('', ['class' => 'form-horizontal']); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				<?php echo form_input('name', $category_data['menu_name'], ['id'=>'name', 'name'=>'name', 'class'=>'form-control', 'tabindex'=>'1']); ?>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<?php echo form_textarea('description', $category_data['article_content'], ['id'=>'description', 'name'=>'description', 'class'=>'form-control editor', 'tabindex'=>'2']); ?>
